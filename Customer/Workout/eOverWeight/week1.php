                ...
                <div class="tab-pane fade show active" id="nav-sunday" role="tabpanel" aria-labelledby="nav-sunday-tab">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eOverWeight/eoGif1.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>6 reps x 4 sets</span>
                                    <h2>Back Squat</h2>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eOverWeight/eoGif2.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>6 reps x 4 sets</span>
                                    <h2>Split Squat</h2>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eOverWeight/eoGif3.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>6 reps x 4 sets</span>
                                    <h2>Romanian Deadlifts</h2>
                                    <span>Rest 15 sec</span>
                                </div>
                            </div>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eOverWeight/eoGif4.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>6 reps x 4 sets</span>
                                    <h2>Hip Thrusts</h2>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eOverWeight/eoGif5.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>6 reps x 4 sets</span>
                                    <h2>Bench Press</h2>
                        ...
                        <div class="col-lg-6">
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eOverWeight/eoGif6.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>6 reps x 4 sets</span>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eOverWeight/eoGif7.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>8 reps x 4 sets</span>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eOverWeight/eoGif8.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>8 reps x 4 sets</span>
                                    <h2>Bent Over Row</h2>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eOverWeight/eoGif9.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>30 secs x 4</span>
                                    <h2>DB Shoulder Press/Underhand Pulldown</h2>
                                    <span>Rest 15 sec</span>
                                </div>
                            </div>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eOverWeight/eoGif10.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>6 reps x 4 sets</span>
                                    <h2>Ab Rollouts/Pallof Holds</h2>
                                    <span>Rest 15 sec</span>
                                </div>
                            </div>
                        </div>
