                ...
                <div class="tab-pane fade show active" id="nav-sunday" role="tabpanel" aria-labelledby="nav-sunday-tab">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eObese/eoGif1.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 3 sets 8 reps</span>
                                    <h2>Pull Up</h2>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eObese/eoGif2.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eObese/eoGif3.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 3 sets 10 reps</span>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eObese/eoGif4.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 3 sets 10 reps</span>
                                    <h2>Dip</h2>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eObese/eoGif5.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 3 sets 8 reps</span>
                                    <h2>Chin Up</h2>
                        ...
                        <div class="col-lg-6">
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eObese/eoGif6.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 3 sets 18 rep each</span>
                                    <h2>Bodyweight Rear Lunge</h2>
                                    <span>Rest 15 sec</span>
                                </div>
                            </div>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eObese/eoGif7.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 3 sets 8 reps</span>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eObese/eoGif8.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 3 sets 8 reps</span>
                                    <h2>Dumbbell Row</h2>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eObese/eoGif9.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 3 sets 8 reps</span>
                                    <h2>Dumbbell Stiff Leg Deadlift</h2>
                                    <span>Rest 15 sec</span>
                                </div>
                            </div>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eObese/eoGif10.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 3 sets 45 secs</span>
                                    <h2>Plank</h2>
                                    <span>Rest 15 sec</span>
                                </div>
                            </div>
