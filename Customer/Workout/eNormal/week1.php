                ...
                <div class="tab-pane fade show active" id="nav-sunday" role="tabpanel" aria-labelledby="nav-sunday-tab">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eNormal/enGif1.gif" alt="Image">
                                </a>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eNormal/enGif2.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>6 reps x 4 sets</span>
                                    <h2>Goblet Squats</h2>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eNormal/enGif3.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>6 reps x 4 sets</span>
                                    <h2>Dumbbell Single Arm Row</h2>
                                    <span>Rest 15 sec</span>
                                </div>
                            </div>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eNormal/enGif4.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>6 reps x 4 sets</span>
                                    <h2>Shoulder Lateral Raise</h2>
                                    <span>Rest 15 sec</span>
                                </div>
                            </div>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eNormal/enGif5.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>6 reps x 4 sets</span>
                                    <h2>Bench Press</h2>
                        ...
                        <div class="col-lg-6">
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eNormal/enGif6.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>6 reps x 4 sets</span>
                                    <h2>Pull Ups/Assisted Pull Ups</h2>
                                    <span>Rest 15 sec</span>
                                </div>
                            </div>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eNormal/enGif7.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>8 reps x 4 sets</span>
                                    <h2>Barbell Bicep Curls</h2>
                                    <span>Rest 15 sec</span>
                                </div>
                            </div>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eNormal/enGif8.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>8 reps x 4 sets</span>
                                    <h2>Cable Overhead Tricep Extensions</h2>
                                    <span>Rest 15 sec</span>
                                </div>
                            </div>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eNormal/enGif9.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
