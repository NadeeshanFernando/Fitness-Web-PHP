                ...
                <div class="tab-pane fade show active" id="nav-sunday" role="tabpanel" aria-labelledby="nav-sunday-tab">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eExtremely/eeGif1.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 4 sets 8 reps</span>
                                    <h2>Barbell Good Morning</h2>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eExtremely/eeGif3.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 4 sets 8 reps</span>
                                    <h2>Barbell Lunge</h2>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eExtremely/eeGif2.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 4 sets 8 reps</span>
                                    <h2>Barbell Squat</h2>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eExtremely/eeGif4.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 4 sets 8 reps</span>
                                    <h2>Barbell Push Press</h2>
                                    <span>Rest 15 sec</span>
                                </div>
                            </div>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eExtremely/eeGif5.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 3 sets 10 reps</span>
                        ...
                        <div class="col-lg-6">
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eExtremely/eeGif6.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 3 sets 10 reps</span>
                                    <h2>Dumbbell Row</h2>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eExtremely/eeGif7.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 3 sets 10 reps</span>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eExtremely/eeGif8.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 5 sets 12 reps</span>
                                    <h2>Machine Ab Crunch</h2>
                                    <span>Rest 15 sec</span>
                                </div>
                            </div>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eExtremely/eeGif9.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 3 sets 6 reps</span>
                                    <h2>Pull Up</h2>
                                    <span>Rest 15 sec</span>
                                </div>
                            </div>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/eExtremely/eeGif10.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 3 sets 6 reps</span>
                                    <h2>Dip</h2>
