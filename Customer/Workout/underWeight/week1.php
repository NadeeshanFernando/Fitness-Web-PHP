                ...
                <div class="tab-pane fade show active" id="nav-sunday" role="tabpanel" aria-labelledby="nav-sunday-tab">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/underWeight/uGif1.gif" alt="Image">
                                </a>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/underWeight/uGif2.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 6</span>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/underWeight/uGif3.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 4</span>
                                    <h2>Knee Push-Ups</h2>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/underWeight/uGif4.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 4</span>
                                    <h2>Push-Ups</h2>
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/underWeight/uGif5.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>x 4</span>
                                    <h2>Wide Arm Push-Ups</h2>
                                    <span>Rest 15 sec</span>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="class-item d-flex align-items-center">
                                <a href="" class="class-item-thumbnail">
                                    <img src="../../assets/images/workout/underWeight/uGif6.gif" alt="Image">
                                </a>
                                <div class="class-item-text">
                                    <span>00:20 sec</span>
                                    <h2>Cobra Stretch</h2>
