...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<table class="table table-bordered table-striped">
				...
				<tbody>
					<?php
						...
						$query = $con->query($sql);
						foreach($_SESSION['cart'] as $key => $detailsnew){
							while($row = $query->fetch_assoc()){
								?>
							
										<a href="delete_item.php?id=<?php echo $row['id']; ?>&index=<?php echo $index; ?>" >delete</a>
									</td>
									<td ><?php echo $fname= $row['name']; ?></td>
			...
			<a href="../Restuarant/allFoodItems.php" class="btn btn-primary"><span class="glyphicon glyphicon-arrow-left"></span> Back</a>
			<button type="submit" class="btn btn-success" name="save">Save Changes</button>
			<a href="clear_cart.php" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Clear Cart</a>
			<a href="./view_cart.php" class="btn btn-success"><span class="glyphicon glyphicon-check"></span> Checkout</a>
			</form>
		</div>
	</div>
</div>
